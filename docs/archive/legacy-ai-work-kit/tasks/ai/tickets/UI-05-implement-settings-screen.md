# UI-05 — Implement Settings screen

## Metadata

- Epic: Application Completion
...
Configure connection/workspace/IronCAD/cache/logging safely.

## Scope

Validated config service + Desktop UI.
...
No plaintext password/token; test connection; invalid config blocked.
...
No credential manager redesign beyond ticket.
