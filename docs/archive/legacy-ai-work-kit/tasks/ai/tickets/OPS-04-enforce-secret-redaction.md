# OPS-04 — Enforce secret redaction
...
Prevent credentials in logs/diagnostics.

## Scope

Logging filters and tests.
...
Known headers/properties redacted; regression tests.
