# WSP-04 — Implement reusable SHA256 service

## Metadata

- Epic: Workspace State
- Dependencies: WSP-03
- Risk: Medium
- Status: Not Started
...
Hash files with cancellation and safe streaming.

## Scope

Workspace/Core abstraction as architecture permits.
...
Stable hash, cancellation, locked/missing file tests; no full-file memory load.
