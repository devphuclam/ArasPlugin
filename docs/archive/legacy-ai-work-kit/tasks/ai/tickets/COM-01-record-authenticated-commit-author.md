# COM-01 — Record authenticated commit author
...
Store trusted Aras user identity on commit.

## Scope

Session-to-PDM Commit mapping.
...
Author comes from session, not user input; missing identity handled.
