# WSP-03 — Implement workspace file scanner
...
Enumerate managed files and metadata.

## Scope

Workspace module, ignore rules, normalized relative paths.
...
Scanner excludes temp/build folders and detects managed CAD/Documents.
