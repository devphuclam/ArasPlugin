# PULL-06 — Download remote files to temp
...
Stage and validate content.

## Scope

Aras Vault + Workspace temp orchestration.
...
All downloads go to operation temp; hash mismatch blocks apply; cleanup tested.
