# DOC-06 — Download real Document files during Clone
...
Replace normal placeholder behavior with Vault download.

## Scope

Clone query, File ID resolution, Vault download, hash validation.
...
Clone reproduces original Document bytes; failed hash does not replace valid local file.
