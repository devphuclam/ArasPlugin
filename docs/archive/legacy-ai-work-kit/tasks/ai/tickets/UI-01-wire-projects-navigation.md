# UI-01 — Wire Projects navigation

## Metadata

- Epic: Application Completion
- Dependencies: PULL-05
- Risk: Low
- Status: Not Started

## Goal

Make sidebar Projects open existing PDM Projects workflow.
...
Button navigates and preserves session/state; no duplicate ViewModel.
