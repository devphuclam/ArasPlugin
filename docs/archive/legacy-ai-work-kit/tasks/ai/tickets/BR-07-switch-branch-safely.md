...
Change workspace branch without losing local work.

## Scope

Workspace/Desktop orchestration.
...
Dirty workspace requires commit/stash-equivalent/discard decision; backup/rollback tested.
...
No automatic stash if not designed.
