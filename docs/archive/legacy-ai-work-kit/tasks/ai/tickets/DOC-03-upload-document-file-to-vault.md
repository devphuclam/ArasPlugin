# DOC-03 — Upload Document file to Vault
...
Upload required PDF/DWG content and return File ID.

## Scope

Aras/Vault path; validation and typed errors.
...
Successful upload returns File ID; missing file/cancel/Vault failure are tested; no false success.
...
Do not attach File to Document yet.
