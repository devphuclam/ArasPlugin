...
Record reproducible test baseline.

## Scope

All xUnit tests and test categories; identify live dependencies.
...
Counts and failing test list are stored; no assertion weakening.
