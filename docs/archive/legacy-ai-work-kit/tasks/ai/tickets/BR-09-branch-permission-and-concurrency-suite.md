# BR-09 — Branch permission and concurrency suite
...
Verify Viewer/Developer/Admin and stale head behavior.

## Scope

Integration tests on test Aras.
...
Unauthorized actions fail; concurrent updates detected; audit recorded.
