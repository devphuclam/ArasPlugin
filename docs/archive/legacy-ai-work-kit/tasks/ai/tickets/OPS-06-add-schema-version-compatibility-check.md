# OPS-06 — Add schema version compatibility check
...
Block incompatible app/server combinations.

## Scope

Login/read-only schema check.
...
Older/newer/missing versions produce actionable status.
