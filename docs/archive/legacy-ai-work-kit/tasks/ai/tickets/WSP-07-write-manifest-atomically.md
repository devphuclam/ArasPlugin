# WSP-07 — Write manifest atomically
...
Prevent corrupt base state on crash.

## Scope

Temp write, flush, atomic replace, backup/recovery.
...
Failure leaves prior manifest readable; success updates once.
