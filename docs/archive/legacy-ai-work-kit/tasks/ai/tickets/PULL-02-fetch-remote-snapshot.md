# PULL-02 — Fetch remote snapshot

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-01
- Risk: High
- Status: Not Started

## Goal

Read branch/live Part/BOM/CAD/Document/File state.

## Scope

Aras client read-only implementation.
...
Snapshot contains stable IDs/hashes/file IDs and handles missing schema/permission.
