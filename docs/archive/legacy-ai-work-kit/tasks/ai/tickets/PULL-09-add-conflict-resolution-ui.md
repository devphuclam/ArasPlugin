# PULL-09 — Add conflict resolution UI

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-08,PULL-05
- Risk: High
- Status: Not Started

## Goal

Collect explicit choices and feed Pull plan.

## Scope

Desktop dialog/ViewModel.
...
Choices persist only for operation; cancel is safe; Save Both naming collision handled.
