# PULL-05 — Add Pull Preview UI

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-04
- Risk: Medium
- Status: Not Started

## Goal

Show all planned changes before mutation.

## Scope

Desktop ViewModel/View, no filesystem writes.
...
Counts/details/conflicts/size shown; cancel changes nothing.
