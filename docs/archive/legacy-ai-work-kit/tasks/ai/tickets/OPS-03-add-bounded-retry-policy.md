# OPS-03 — Add bounded retry policy
...
HTTP/Vault reads and idempotent calls.
...
No retry for permission/validation; backoff/cancel tests.
...
No blanket retry around mutations.
