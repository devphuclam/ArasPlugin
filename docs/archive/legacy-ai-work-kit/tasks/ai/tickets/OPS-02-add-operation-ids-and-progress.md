# OPS-02 — Add operation IDs and progress
...
Trace one operation across layers.

## Scope

Contracts/logging/UI progress.
...
Stable operation ID, progress cancellation, correlation in errors.
