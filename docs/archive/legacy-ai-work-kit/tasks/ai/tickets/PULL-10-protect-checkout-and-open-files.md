# PULL-10 — Protect checkout and open files

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-07
- Risk: Critical
- Status: Not Started

## Goal

Prevent overwrite of unsafe CAD files.

## Scope

Desktop/IronCAD state + Aras lock checks via services.
...
Modified/open/other-user-locked cases block or conflict; tests/fakes.
