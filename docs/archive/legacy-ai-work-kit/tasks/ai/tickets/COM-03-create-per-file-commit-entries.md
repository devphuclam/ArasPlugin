# COM-03 — Create per-file commit entries
...
Persist exact changed files.

## Scope

Commit model and creation path.
...
Entries include relative path/role/hash/entity; no unchanged entries by default.
...
No change-type enhancement beyond current diff mapping.
