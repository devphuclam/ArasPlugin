# BR-03 — Manage branch head atomically

## Metadata

- Epic: Remote Branch
- Dependencies: BR-02,COM-02
- Risk: Critical
- Status: Not Started

## Goal

Advance head only after commit success.

## Scope

Server/client transaction method.
...
Concurrent stale-head update fails clearly; successful commit advances once.
