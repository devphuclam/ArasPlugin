# COM-06 — Query and display commit history
...
Expose audit history without changing data.

## Scope

Read client + minimal Desktop view/model.
...
History orders by parent/date, shows author/message/files; failures are non-destructive.
