# BR-02 — Implement remote branch repository service
...
List/create/archive/read branches.

## Scope

Aras client + Core contracts.
...
Idempotent create, duplicate validation, read-only list tests.
