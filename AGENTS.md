...
- Spec Kit is installed at the project level. OpenCode commands live under
  `.opencode/commands/`, and Codex skills live under `.agents/skills/speckit-*`.
  Their setup and versioning are documented in
