# COM-07 — Commit integration suite
...
Verify sequence and schema on test Aras.

## Scope

First/second commit, file changes, author, parent, Vault IDs.
...
Integration evidence proves chain and file entries.
