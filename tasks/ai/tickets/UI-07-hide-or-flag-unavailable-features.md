# UI-07 — Hide or flag unavailable features
...
Prevent decorative broken buttons in release.

## Scope

Feature flags/visibility based on readiness.
...
Unavailable actions hidden/disabled with reason; no fake success message.
