# BASE-00 — Establish clean backed-up baseline
...
Protect current work before AI changes.

## Scope

Git status, backup branch/tag/archive, identify intentional vs accidental changes.
...
Working tree state is documented; recoverable backup exists; AI starts from an explicit commit.
