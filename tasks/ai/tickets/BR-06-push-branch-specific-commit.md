# BR-06 — Push branch-specific commit

## Metadata

- Epic: Remote Branch
- Dependencies: BR-03,COM-07
- Risk: Critical
- Status: Not Started

## Goal

Create branch commit without mutating live main data.

## Scope

Push orchestration and stale-head check.
...
Non-main content goes to branch snapshot; head advances; live main unchanged.
