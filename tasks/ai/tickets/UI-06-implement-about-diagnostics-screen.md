# UI-06 — Implement About/Diagnostics screen
...
Show version, commit, schema/method status and export diagnostics.

## Scope

Read-only UI and redacted diagnostics.
...
No secret exposure; environment status explicit.
