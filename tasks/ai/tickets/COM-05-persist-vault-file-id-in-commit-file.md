# COM-05 — Persist Vault File ID in commit file

## Metadata

- Epic: Commit History
- Dependencies: COM-04,DOC-04
- Risk: High
- Status: Not Started

## Goal

Link history entry to physical content.

## Scope

PDM Commit File schema/client.
...
Uploaded file entries store correct Vault File ID; deleted entry preserves previous reference if policy requires.
