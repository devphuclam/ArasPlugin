# BR-04 — Clone branch-specific snapshot

## Metadata

- Epic: Remote Branch
- Dependencies: BR-03,COM-05
- Risk: High
- Status: Not Started

## Goal

Clone content referenced by branch head.

## Scope

Clone path using commit files/Vault.
...
Branch A/B produce their own snapshot; hash verified.
