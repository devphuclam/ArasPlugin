# WSP-06 — Implement Part and BOM diff
...
Detect business-structure changes.

## Scope

Pure DTO comparison using stable IDs/logical codes and quantity.
...
Added/removed/quantity/metadata changes tested.
