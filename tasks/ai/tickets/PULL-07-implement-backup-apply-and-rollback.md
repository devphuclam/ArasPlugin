# PULL-07 — Implement backup, apply and rollback

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-06,WSP-07
- Risk: Critical
- Status: Not Started
...
Workspace atomic operation service.
...
Failure restores prior workspace and manifest; operation log records outcome.
