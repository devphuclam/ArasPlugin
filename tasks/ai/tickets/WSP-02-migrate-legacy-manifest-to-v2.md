# WSP-02 — Migrate legacy manifest to v2
...
Open existing workspaces without data loss.

## Scope

Versioned reader/migration and backup.
...
Legacy fixtures migrate deterministically; invalid manifest gives recoverable error.
