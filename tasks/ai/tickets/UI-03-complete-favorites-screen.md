# UI-03 — Complete Favorites screen
...
Unify existing Part favorites and supported entities.

## Scope

Desktop + existing favorite service only.
...
Add/remove/open works and survives refresh.
...
No new Aras schema without ticket.
