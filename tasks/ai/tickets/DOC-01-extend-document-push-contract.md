...
Carry physical-file identity through repository contract.

## Scope

PdmDocumentRequest/related DTOs only, with source path/hash/size fields and compatibility defaults.
...
Compile-safe contract; serialization/mapping tests; no behavior change.
