...
Obtain reproducible build evidence.

## Scope

Solution/project membership, Windows build prerequisites, restore/build commands.
...
Exact build command and pass/fail log; failures classified.
...
Do not fix unrelated errors in this ticket.
