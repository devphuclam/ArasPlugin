# PULL-08 — Define conflict model and policies

## Metadata

- Epic: Pull/Sync
- Dependencies: PULL-03
- Risk: High
- Status: Not Started

## Goal

Represent Keep Local/Use Server/Save Both/Skip/Cancel.

## Scope

Core/Workspace policy logic.
...
Every conflict requires explicit resolution; binary auto-merge absent.
