# OPS-07 — Create repeatable integration environment guide
...
Document safe test database/data/users/files.

## Scope

Scripts/docs without secrets.
...
Another developer can reproduce test setup.
