# WSP-05 — Implement file Diff Engine
...
Classify Added/Modified/Deleted/Unchanged/Renamed where supported.

## Scope

Pure Workspace business logic.
...
Table-driven tests cover all classifications and path normalization.
