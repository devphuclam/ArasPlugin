# BASE-03 — Install AI governance workflow
...
Adopt this work kit in Git.

## Scope

Commit docs/templates/scripts and confirm unignore rules.
...
Work kit files are tracked and start/verify scripts run.
