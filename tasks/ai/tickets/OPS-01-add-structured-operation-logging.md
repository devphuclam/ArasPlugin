# OPS-01 — Add structured operation logging
...
Create consistent logs for Clone/Push/Pull/Commit/Revision.

## Scope

Logging abstraction/events, not business redesign.
...
Operation type/status/duration/safe IDs recorded; tests.
